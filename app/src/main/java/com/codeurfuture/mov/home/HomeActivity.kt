...
import com.codeurfuture.mov.home.dashboard.DashboardFragment
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        iv_menu1.setOnClickListener {
           setFragment(fragmentHome)
            ...
            changeIcon(iv_menu1, R.drawable.ic_home_active2)
        ...
        iv_menu2.setOnClickListener {
            ...
            changeIcon(iv_menu2, R.drawable.ic_ticket_active2)
            changeIcon(iv_menu3, R.drawable.ic_profile)
        }
        ...
        iv_menu3.setOnClickListener {
            ...
            changeIcon(iv_menu1, R.drawable.ic_home)
            changeIcon(iv_menu2, R.drawable.ic_ticket)
            changeIcon(iv_menu3, R.drawable.ic_profile_active2)
        }
    }
